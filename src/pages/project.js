...
import TechnologiesList from "../component/technologies.list"
                    ...
                    <div className="card-body p-0">
                        <div className="d-flex">
                            ...
                            <div className="d-flex flex-column accent-line">
                                ...
                                <div className="bg-secondary" style={{ height: "30%" }}>
                                    {}
                                </div>
                                <div className="bg-success" style={{ height: "20%" }}>
                                    {}
                                </div>
                            </div>
                            {/* project details */}
                            <div className="p-4">
                                ...
                                <p className="mt-4">
                                    {technologies.map((value, index) => (
                                        <TechnologiesList key={index} index={index} text={value} />
                                    ))}
                                </p>
                            </div>
                        </div>
            ...
            <TemplateDefault>
                <div className="row row-cols-1 row-cols-lg-2 mt-5">
                    {data.allMarkdownRemark.nodes.map((value) => (
                        <ProjectList key={value.id} data={value} />
                    ))}
                </div>
            </TemplateDefault>
        </Fragment>
